...
fit_dep_y_calib<-fitPagel(insect.tree,x,y,dep.var="y", method = "fitMk", model = "ARD", pi = "fitzjohn") # x is dependent on y

# Save the result
saveRDS(fit_dep_y_calib,"fulltree_dep_y_fitMk_ARD_fitzjohnpi_hdarrhenotoky_calib_2020.RDS")
#-------------------------------------------------------------------------------