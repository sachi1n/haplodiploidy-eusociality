...
# NOTE: This R script is for the Chester's new phylogeny (2020) 
...
# NOTE: For this script, Haplodiploidy is used in a broad sense (HD.all). The definition of eusociality is strict and follows Boomsma and Gawne(https://onlinelibrary.wiley.com/doi/10.1111/brv.12330)
...
# Save the result
saveRDS(fit_dep_xy_calib,"fulltree_dep_xy_fitMk_ARD_fitzjohnpi_hdall_EusKoos_calib_2020.RDS")
#-------------------------------------------------------------------------------