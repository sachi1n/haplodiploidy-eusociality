...
fitpagel_halictidae_pruned = ("C:/Users/sachi/OneDrive - Texas Tech University/Linksvayer Lab/Projects/Haplodiploidy and Eusociality/FitPagel_halictidae_pruned/")
fitpagel_halictidae_pruned = ("C:/Users/ssures53/OneDrive - Arizona State University/Linksvayer Lab/Projects/Haplodiploidy and Eusociality/FitPagel_halictidae_pruned/")
...
fit_dep_xy_calib<-fitPagel(insect.tree,x,y,dep.var="xy", method = "fitMk", model = "ARD", pi = "fitzjohn") # x and y are interdependent

# Save the result
saveRDS(fit_dep_xy_calib,"halictidae_pruned_dep_xy_fitMk_ARD_fitzjohnpi_haparrhenotoky_calib_2020.RDS")
#-------------------------------------------------------------------------------