...
# NOTE: In this script, haplodiploidy is used in the strict sense (HD.arrhenotoky) and eusociality is used in strcit sense (Eusocial.strict)
...
# Save the result
saveRDS(fit_dep_xy_calib,"halictidae_pruned_dep_xy_fitMk_ARD_fitzjohnpi_haparrhenotoky_euskoos_calib_2020.RDS")
