...
# NOTE: In this script, halictidae is pruned to "force" two independent origins of eusocilality in that clade
...
# Save the result
saveRDS(fit_dep_x_calib,"halictidae_pruned_dep_x_fitMk_ARD_fitzjohnpi_calib_2020.RDS")
#-------------------------------------------------------------------------------