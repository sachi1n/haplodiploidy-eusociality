...
fit_dep_y_calib<-fitPagel(insect.tree,x,y,dep.var="y", method = "fitMk", model = "ARD", pi = "fitzjohn") # y is dependent on x

# Save the result
saveRDS(fit_dep_y_calib,"halictidae_pruned_dep_y_fitMk_ARD_fitzjohnpi_haparrhenotoky_calib_2020.RDS")
#-------------------------------------------------------------------------------