...
# NOTE: For this script, Haplodiploidy is used in a strict sense (HD.arrhenotoky)
...
# Save the result
saveRDS(fit_dep_xy_calib,"fulltree_dep_xy_fitMk_ARD_fitzjohnpi_hdarrhenotoky_calib_2020.RDS")
#-------------------------------------------------------------------------------