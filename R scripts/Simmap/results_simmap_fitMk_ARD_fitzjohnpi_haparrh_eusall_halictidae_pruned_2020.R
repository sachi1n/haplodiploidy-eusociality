...
# NOTE: Haplodiploidy is used in strict sense and Eusociality are used in broad sense
...
simmap.trees = readRDS("hap_and_eus_simmap_fitMk_ARD_fitzjohnpi_haparrh_eusall_halictidae_pruned_2020.RDS")
#-------------------------------------------------------------------------------
...
write.csv(clades.df, file = "clades_df_simmap_haparrh_eusall_halpruned_2020.csv", row.names = FALSE)
...
ggsave(filename = "eusocial_origins_clades_haparrh_eusall_halpruned_2020.svg", plot = p1, device = svglite, path = fig, width = 8, height = 6)
