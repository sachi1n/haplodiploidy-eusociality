...
simmap = ("C:/Users/ssures53/OneDrive - Arizona State University/Linksvayer Lab/Projects/Haplodiploidy and Eusociality/Final results/Simmap/updated final results")
...
pheno.df$ploidy.sociality=interaction(pheno.df$HD.arrhenotoky,pheno.df$Eus.strict.koos.gawne)
...
# Save the result
saveRDS(ps.ss.trees,"hap_and_eus_simmap_fitMk_ARD_fitzjohnpi_haparrh_euskoos_halictidae_pruned_2020.RDS")
#-------------------------------------------------------------------------------