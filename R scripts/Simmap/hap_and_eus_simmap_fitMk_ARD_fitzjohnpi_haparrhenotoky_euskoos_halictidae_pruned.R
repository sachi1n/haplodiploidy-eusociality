...
# NOTE: In this script, haplodiploidy is used in the strict sense (HD.arrhenotoky). Eusociality is also used in strict sense (Eusocial.strcit)
...
simmap = ("C:/Users/ssures53/OneDrive - Arizona State University/Linksvayer Lab/Projects/Haplodiploidy and Eusociality/Final results/Simmap/updated final results") #directory for ASU desktop
...
# Save the result
saveRDS(ps.ss.trees,"hap_and_eus_simmap_fitMk_ARD_fitzjohnpi_haparrhenotoky_euskoos_halictidae_pruned.RDS")
#-------------------------------------------------------------------------------