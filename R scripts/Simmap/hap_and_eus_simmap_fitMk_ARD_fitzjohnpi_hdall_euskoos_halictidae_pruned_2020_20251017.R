...
pheno.df$ploidy.sociality=interaction(pheno.df$HD.all,pheno.df$Eus.strict.koos.gawne)
...
# Save the result
saveRDS(ps.ss.trees,"hap_and_eus_simmap_fitMk_ARD_fitzjohnpi_hapall_euskoos_halictidae_pruned_2020.RDS")
#-------------------------------------------------------------------------------