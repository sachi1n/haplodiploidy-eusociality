...
# NOTE: In this script, haplodiploidy is used in the broad sense (HD.all). Eusociality is used in a strict sense (Eus.strict) 
...
# Save the result
saveRDS(ps.ss.trees,"hap_and_eus_simmap_fitMk_ARD_fitzjohnpi_hdall_euskoos_fulltree_2020.RDS")
#-------------------------------------------------------------------------------