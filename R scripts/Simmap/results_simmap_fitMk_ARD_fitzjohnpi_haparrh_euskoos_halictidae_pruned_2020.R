...
# NOTE: Haplodiploidy and Eusociality are used in strict sense
...
simmap.trees = readRDS("hap_and_eus_simmap_fitMk_ARD_fitzjohnpi_haparrh_euskoos_halictidae_pruned_2020.RDS")
#-------------------------------------------------------------------------------
...
write.csv(clades.df, file = "clades_df_simmap_haparrh_euskoos_halpruned_2020.csv", row.names = FALSE)
clades.df = read.csv("clades_df_simmap_haparrh_euskoos_halpruned_2020.csv")
...
ggsave(filename = "eusocial_origins_clades_haparrh_euskoos_halpruned_2020.svg", plot = p1, device = svglite, path = fig, width = 8, height = 6)
