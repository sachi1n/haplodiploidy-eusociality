...
pheno.df$ploidy.sociality=interaction(pheno.df$HD.all,pheno.df$Eusocial.strict)
...
# Save the result
saveRDS(ps.ss.trees,"hap_and_eus_simmap_fitMk_ARD_fitzjohnpi_hdall_euskoos_fulltree.RDS")
#-------------------------------------------------------------------------------